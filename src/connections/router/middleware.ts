...
export default class Middleware {
   ...
   * @param app Express app.
   */
  private logRequests(app: express.Express): void {
   ...
   * @param app Express app.
   */
  private initSecurity(app: express.Express): void {
    app.use(
      cors({
  ...
  /**
   * Init generic middleware.
   * @param app Express app.
   */
  private initGenericMiddleware(app: express.Express): void {
